...
function Projects(props) {
  ...
  function AnimateProjects() {
    ...
    moveElement(projectsHeader, animationTime, { bottom: "-100px" }, { bottom: "0px" }, async () => {
